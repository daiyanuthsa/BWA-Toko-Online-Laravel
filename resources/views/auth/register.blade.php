                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" name="email" type="email"
                                    ...
                                    :class="{ 'is-invalid': 'this.email_unavailable' }" v-model="email"
                                    @change="emailAvailability()" required autocomplete="email" />
                                <x-input-error :messages="$errors->get('email')" class="mt-2" />
                            </div>
                            <div class="form-group">
                                <label for="password">Password</label>
                                <input id="password" type="password"
                                    class="form-control @error('password') is-invalid @enderror" v-model="password"
                            ...
                            <div class="form-group">
                                ...
                                <input id="password_confirmation" type="password"
                                    ...
                                    v-model="password_confirmation" name="password_confirmation" required
                            ...
                            <div class="form-group" v-if="is_store_open === 'true'">
                                ...
                                <input id="store_name" type="text"
                                    class="form-control @error('store_name') is-invalid @enderror" v-model="store_name"
                                    name="store_name" required autofocus autocomplete="store_name" />
